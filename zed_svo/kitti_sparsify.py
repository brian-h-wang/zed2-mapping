"""
Module for sparsifying stereo point clouds to make KITTI-like "lidar" data.

Original code written by Yan Wang, see:
https://github.com/mileyan/Pseudo_Lidar_V2/blob/master/src/preprocess/kitti_sparsify.py
...
def sparsify_pointcloud(stereo_pointcloud, height=64, width=512, slice=1):
    sparse_points = pto_ang_map(stereo_pointcloud, H=height, W=width, slice=slice)
